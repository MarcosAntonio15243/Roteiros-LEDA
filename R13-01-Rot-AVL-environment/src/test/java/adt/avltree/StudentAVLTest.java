...
public class StudentAVLTest {
	...
	// EXTRA
	@Test
	public void testInsertRebalanceRight() {
		avl.insert(100);
		avl.insert(90);
		assertArrayEquals(new Integer[]{ 100, 90 }, avl.preOrder());
		avl.insert(80);
		assertArrayEquals(new Integer[]{ 90, 80, 100 }, avl.preOrder());

		avl.insert(70);
		assertArrayEquals(new Integer[]{ 90, 80, 70, 100 }, avl.preOrder());

		avl.insert(75);
		assertArrayEquals(new Integer[]{ 90, 75, 70, 80, 100 }, avl.preOrder());
	}
