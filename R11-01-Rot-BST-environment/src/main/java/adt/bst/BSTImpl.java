...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
	...
	private void setInfoBTSNode(BSTNode<T> node, T element, BTNode<T> parent, BTNode<T> left, BTNode<T> right) {
	...
	private BSTNode<T> createBTSNodeBuild(T element) {
	 ...
	 */
	private void removeNodeOneChild(BSTNode<T> node) {
